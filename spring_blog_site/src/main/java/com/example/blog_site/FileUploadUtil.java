...
public class FileUploadUtil {
    ...
    public static final String BLOG_UPLOAD_FOLDER = "blog-photos";
    public static final String BLOG_UPLOAD_DIRECTORY = BLOG_UPLOAD_FOLDER + FILE_SEPARATOR;
    public static final String BLOG_DEFAULT_IMAGE_PATH = "/images/default-blog.png";
